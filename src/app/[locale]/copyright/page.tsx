...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Farever',
    description: 'Copyright and intellectual property information for Farever. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Farever',
      title: 'Copyright Notice - Farever',
      description: 'Copyright and intellectual property information for Farever.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Farever. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Farever and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Farever is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Farever Developers</strong> - Creators of the Farever game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Farever</strong> - Trademark of the game developers</li>
              <li><strong>Farever</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Farever<br />
              Email: <a href="mailto:dmca@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@farever.org</a>
            </p>
            <p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@farever.org</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@farever.org</a>
            </p>
            <p>
