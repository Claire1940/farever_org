...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Farever - Your Ultimate Steam Game Resource',
    description: 'Learn about Farever, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Farever Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'Farever',
      title: 'About Farever',
      description: 'Learn about our mission to provide the best Farever game resources and guides.',
      images: [
        {
    ...
    twitter: {
      ...
      title: 'About Farever',
      description: 'Learn about our mission to provide the best Farever game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Farever
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Farever</h2>
            <p>
              Farever is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "Farever". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Farever is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Farever players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Farever as the <strong>go-to destination</strong> for every Farever player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Farever is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Farever is maintained by a dedicated team of passionate gamers and developers who love
              Farever as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Farever mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Farever is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Farever or any official entities.
            </p>
            <p>
            ...
            <p>
              Farever is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@farever.org
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@farever.org
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@farever.org
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@farever.org" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@farever.org
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Farever news.
