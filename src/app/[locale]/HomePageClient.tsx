    ...
    "@graph": [
      {
        ...
        name: "Farever",
        description:
          "Farever guides covering classes, builds, dungeons, crafting, roadmap updates, and multiplayer progression.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Farever - Online Co-op Action RPG",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Farever",
        alternateName: "Farever Game Community",
        url: siteUrl,
        description:
          "Community resource hub for Farever classes, builds, dungeons, and Early Access updates.",
        logo: {
          "@type": "ImageObject",
        ...
        sameAs: [
          ...
          "https://steamcommunity.com/app/3672400",
          "https://www.reddit.com/r/FareverGame/",
          "https://www.youtube.com/@Shiro_Games",
          "https://x.com/Farever_Game",
        ],
      },
      {
        "@type": "VideoGame",
        ...
        genre: ["Action RPG", "Online Co-op", "Open World", "Crafting"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 4,
        },
        offers: {
          ...
          url: "https://store.steampowered.com/app/3672400/Farever/",
        },
      },
      {
        "@type": "VideoObject",
        ...
        description:
          "Official Farever Early Access trailer from Shiro Games.",
        uploadDate: "2026-05-06",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: `https://www.youtube.com/embed/${homeVideo.videoId}`,
        url: `https://www.youtube.com/watch?v=${homeVideo.videoId}`,
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://store.steampowered.com/app/3672400/Farever/"
                target="_blank"
            ...
            {t.modules.lucidBlocksCreaturesAndEnemies.creatures.map(
              (c: any, index: number) => (
                ...
                >
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2 py-1 rounded-full border ${["Hostile Enemy", "Major Threat", "Elite Threat"].includes(c.role) ? "bg-[hsl(var(--nav-theme)/0.15)] border-[hsl(var(--nav-theme)/0.45)] text-[hsl(var(--nav-theme-light))]" : "bg-[hsl(var(--nav-theme)/0.1)] border-[hsl(var(--nav-theme)/0.3)]"}`}
                    >
                      {c.role}
                    </span>
                  </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    href="https://steamcommunity.com/app/3672400"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[hsl(var(--nav-theme)/0.1)] border border-[hsl(var(--nav-theme)/0.3)] text-sm hover:bg-[hsl(var(--nav-theme)/0.2)] transition-colors"
                  >
                    <MessageCircle className="w-4 h-4" /> Discord (via Steam){" "}
